...
def main() -> None:
    ...
    check("46_six_pages", len(metrics["publication"]["publishedStateIntelligencePaths"]) == 11 and "/virginia" in metrics["publication"]["publishedStateIntelligencePaths"] and "/new-york" in metrics["publication"]["publishedStateIntelligencePaths"] and "/illinois" in metrics["publication"]["publishedStateIntelligencePaths"] and "/oregon" in metrics["publication"]["publishedStateIntelligencePaths"] and "/pennsylvania" in metrics["publication"]["publishedStateIntelligencePaths"])
