...
def test_regression() -> None:
    ...
    check("52_no_new_jersey_public_route", not (ROOT / "app" / "new-jersey").exists())
    sitemap = (ROOT / "app" / "sitemap.ts").read_text(encoding="utf-8")
    check("53_no_sitemap_indexing_expansion", "/new-jersey'" not in sitemap and '"/new-jersey"' not in sitemap)
