...
assert(INS_INSURER_005_WAVE1_SIZE === 0 && INS_INSURER_005_PUBLISHED_URLS === 0, '005 did not launch Wave 1 URLs');
assert(INS_INSURER_005_SITEMAP_DELTA === 0, '005 sitemap delta remains 0 in 005 constants');
