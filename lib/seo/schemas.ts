...
export const homepageWebPageSchema = {
  ...
  "@id": `${SITE_URL}/#webpage`,
  url: `${SITE_URL}/`,
  name: "Insurance Agency, License, Carrier & Regulatory Research",
  description:
    "Independent research across insurance entity identity, licensing, appointments, complaints, examinations, rate filings, and public regulatory evidence.",
