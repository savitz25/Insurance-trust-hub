...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    relatedLinks: [
      ...
      { href: '/directory?verified=true', label: 'Browse verified research listings' },
    ],
  },
];
