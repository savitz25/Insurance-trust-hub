...
export const CURATED_HUB_CONFIG: Record<string, CuratedHubConfig> = {
  ...
  jacksonville: {
    slug: 'jacksonville',
    sectionTitle: 'Duval County (Jacksonville metro)',
    summary:
      'Florida DFS–verified research listings for Duval County only. St. Johns, Clay, and Nassau are metro context — not full launch inventory yet. Independent research only — re-check licenses on official DFS tools. Medicare specialty is never inferred from DFS alone.',
    counties: ['Duval (inventory)', 'St. Johns (context)', 'Clay (context)', 'Nassau (context)'],
    badges: ['Launch inventory: Duval', 'FL DFS verified'],
    featuredHealthLine: 'Browse verified research listings below',
