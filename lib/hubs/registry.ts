...
export const INSURANCE_HUBS: InsuranceHub[] = [
  ...
  { slug: 'orlando', stateSlug: 'florida', stateCode: 'FL', stateName: 'Florida', msaName: 'Orlando-Kissimmee-Sanford', shortName: 'Orlando', population: 2_700_000, enrollmentHighlight: 'Hospitality workforce ACA and retiree Medicare growth', localDescriptor: 'hospitality workers, theme-park economy, and Central Florida retirees', priority: 21, zipCodes: ['32801', '34741', '32771'], healthInsuranceDensity: 'high', marketSnapshot: 'Orlando\'s hospitality economy creates ACA demand among seasonal workers while retiree communities drive Medicare growth in surrounding counties.', healthNeeds: ['Hospitality ACA', 'Seasonal worker coverage', 'Medicare'], metaTitle: 'Insurance Agents in Orlando Metro (2026)', metaDescription: 'Health and Medicare agents in Orlando-Kissimmee-Sanford.' },
